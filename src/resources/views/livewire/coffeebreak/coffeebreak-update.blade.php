<main x-data>
    <x-slot name="header">
        ...
        <nav class="flex items-center text-sm font-medium mt-1">
            ...
            <a href="{{route('coffeebreaks')}}" class="text-yellow-600 hover:text-gray-700 focus:outline-none focus:underline transition duration-150 ease-in-out">
                Coffeebreaks
            </a>
            <svg class="flex-shrink-0 mx-2 h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
            ...
            <a href="#" class="text-gray-500 hover:text-gray-700 focus:outline-none focus:underline transition duration-150 ease-in-out">
               Editar um espaço para coffeebreak
            </a>
        </nav>
    </x-slot>
            ...
            <div class="px-6">
                    ...
                    <div class="px-4 py-5 sm:px-6 grid grid-cols-2">
                        <div class="">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">
                                Informações sobre o espaço para coffeebreak
                            </h3>
                            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                                Visualize ou gerencie informações do espaço.
                            </p>
                        </div>
                    <div class="text-right mt-2 ">

                        <a href="{{route('coffeebreaks')}}"
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-lg mt-9">
                    <div class="px-4 py-5 sm:px-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">
                            Atualizar os dados do espaço
                        </h3>
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">
                            Nesta área os dados do espaço poderão ser atualizados.
                        </p>
                    </div>
                        ...
                        <dl>
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-700">
                                    ...
                                    <p class="text-sm text-gray-600">Preencha os novos dados do espaço.</p>
                                </dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
