            ...
            <div class="px-6">
                    ...
                    <div class="px-4 py-5 sm:px-6 grid grid-cols-2">
                        <div class="">
                            ...
                            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                                Visualize ou gerencie informações da pessoa.
                            </p>
                        </div>
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-lg mt-9">
                    <div class="px-4 py-5 sm:px-6">
                        ...
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">
                            Nesta área os dados da pessoa poderão ser atualizados.
                        </p>
                    </div>
                        ...
                        <dl>
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-700">
                                    ...
                                    <p class="text-sm text-gray-600">Preencha os novos dados da pessoa.</p>
                                </dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
