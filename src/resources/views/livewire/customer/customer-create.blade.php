<main x-data>
    <x-slot name="header">
        ...
        <nav class="flex items-center text-sm font-medium mt-1">
            ...
            <a href="{{route('customers')}}" class="text-yellow-600 hover:text-gray-700 focus:outline-none focus:underline transition duration-150 ease-in-out">
                Pessoas
            </a>
            <svg class="flex-shrink-0 mx-2 h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-lg mt-9">
                    <div class="px-4 py-5 sm:px-6">
                        ...
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">
                            Nesta área você pode cadastrar uma nova pessoa no sistema.
                        </p>
                    </div>
                        ...
                        <dl>
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-700">
                                    ...
                                    <p class="text-sm text-gray-600">Preencha os dados da pessoa.</p>
                                </dt>
                                    ...
                                    <div class="px-0">
                                        <form wire:submit.prevent method="POST">
                                            ...
                                            <div class="rounded-md shadow-sm -space-y-px">
                                                ...
                                                <div>
                                                    <label for="name" class="sr-only">Nome da pessoa</label>
                                                    <input
                                                        wire:model="name"
                                                        id="name"
                                                        name="name"
                                                ...
                                                <div>
                                                    <label for="surname" class="sr-only">Sobrenome da pessoa</label>
                                                    <input
                                                        wire:model="surname"
                                                        id="surname"
                                                        name="surname"
                                                    ...
                                                    @error('surname') <span class="error text-red-700">{{ $message }}</span> @enderror
                                                </div>
                                                <div>
                                                    ...
                                                    @error('cpf') <span class="error text-red-700">{{ $message }}</span> @enderror
                                                </div>
                                            </div>
                                            <div class="mt-4">
